...
const canViewBookmarks = computed(
    () => user.value?.settings?.publicBookmarks || sessionUser.value?.username === username.value,
)
    ...
    <div v-else-if="user" class="flex w-full flex-col gap-6 px-2">
        ...
        <div class="flex w-full flex-col items-start gap-3">
            <div class="flex w-full items-center gap-6">
                ...
                <div class="ml-auto">
                    <ButtonUserFollow
                        v-if="sessionUser?.username !== username"
                        :username
            ...
            <div class="text-muted flex items-center gap-1 px-3 text-sm">
                <template v-if="user.followeesCount || sessionUser?.username === user.username">
                ...
                <template v-if="user.followersCount || sessionUser?.username === user.username">
            ...
            <div class="flex w-full flex-col gap-3 px-2 empty:hidden">
                ...
                <div class="ml-auto flex items-center gap-1">
                    <UButton
                        v-if="sessionUser?.username === user.username"
                    ...
                    <template v-else>
                        ...
                        <UButton
                            ...
                            @click="
                                sessionUser
                                    ? reportUser.open({ userId: user.username })
                                    : login.open()
                            "
                        />
                    </template>
        ...
        <div class="flex w-full flex-col gap-5 px-2">
            ...
            <div v-if="canViewBookmarks" class="flex flex-wrap items-center gap-1">
                ...
                <UButton
                    v-if="tab === 'bookmarked' && sessionUser?.username === user.username"
