...
<template>
    <div class="relative flex flex-col items-center gap-8 lg:h-full">
        ...
        <div
            v-else
            class="scrollbar-thin scrollbar-thumb-(--ui-bg-accented) scrollbar-track-transparent flex w-full flex-col gap-6 overflow-y-auto p-1 lg:absolute lg:inset-0 lg:mt-10"
        >
            <div
