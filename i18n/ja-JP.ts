...
export default defineI18nLocale(async () => ({
    ...
    toast: {
        userSettings: {
            ...
            saveFailedDescription: 'プロフィールの保存中にエラーが発生しました。',
            invalidLink: '無効なリンク',
            invalidLinkDescription: '正しいURLを入力してください。',
            linkExists: 'リンクがすでに存在します',
            linkExistsDescription: '同じリンクは追加できません。',
            usernameChanged: 'ユーザーIDが変更されました',
            usernameChangeDescription: 'ページを更新しています...',
            usernameChangeFailed: 'ユーザーIDの変更に失敗しました',
            usernameChangeFailedDescription: 'ユーザーIDの変更中にエラーが発生しました。',
            shopVerified: 'ショップを認証しました',
            shopVerifyFailed: 'ショップの認証に失敗しました',
            shopUnverified: 'ショップの認証を解除しました',
            shopUnverifyFailed: 'ショップの認証解除に失敗しました',
            accountDeleted: 'アカウントを削除しました',
            accountDeleteDescription: 'ページをリロードしています...',
            accountDeleteFailed: 'アカウントを削除できませんでした',
            accountDeleteFailedDescription: '時間をおいて再度お試しください。',
        },
        bookmarks: {
            added: 'ブックマークしました',
            removed: 'ブックマークを解除しました',
            toggleFailed: 'ブックマークの変更に失敗しました',
        },
        reports: {
            submitted: '報告が送信されました',
            submittedDescription: 'ご協力ありがとうございます。',
            submitFailed: '報告の送信に失敗しました',
            unknownError: '不明なエラーが発生しました',
        },
        admin: {
            reportResolved: 'Marked as Resolved',
            reportUnresolved: 'Marked as Unresolved',
            error: 'Error',
            userBanned: 'ユーザーをBANしました',
            userBanFailed: 'ユーザーのBANに失敗しました',
            userUnbanned: 'ユーザーのBANを解除しました',
            userUnbanFailed: 'ユーザーのBAN解除に失敗しました',
            feedbackClosed: 'フィードバックをクローズしました',
            feedbackCloseFailed: 'フィードバックのクローズに失敗しました',
            feedbackOpened: 'フィードバックをオープンしました',
            feedbackOpenFailed: 'フィードバックのオープンに失敗しました',
            setupHidden: 'セットアップが非表示になりました',
            setupHideFailed: 'セットアップの非表示に失敗しました',
            setupUnhidden: 'セットアップが再表示されました',
            setupUnhideFailed: 'セットアップの再表示に失敗しました',
            setupDeleted: 'セットアップが削除されました',
            setupDeleteDescription: 'セットアップが正常に削除されました。',
            setupDeleteFailed: 'セットアップの削除に失敗しました',
            feedbackSubmitted: 'フィードバックが送信されました',
            feedbackSubmittedDescription: 'ご協力ありがとうございます。',
            feedbackSubmitFailed: 'フィードバックの送信に失敗しました',
            toggleFailed: '切替えに失敗しました',
            forceUpdateItemToggled: 'アイテム情報の強制更新を切り替えました',
            forceUpdateItemToggleFailed: '切換えに失敗しました',
            itemNiceNameChanged: 'アイテムの名称を変更しました',
            itemNiceNameChangeFailed: 'アイテムの名称の変更に失敗しました',
            changelogCreated: 'Changelog created successfully',
            changelogCreateFailed: 'Failed to create changelog',
        },
    },

    reports: {
        validation: {
            selectReason: '報告の理由を選択してください',
            otherRequiresComment: 'その他を選択した場合は詳細を入力してください',
        },
    },
    ...
    setup: {
        compose: {
            ...
            editModeFailed: '編集モードを開始できませんでした',
            setupNotFound: '指定されたセットアップが見つかりません。',
            updateFailed: 'セットアップの更新に失敗しました',
            publishFailed: 'セットアップの投稿に失敗しました',
            refreshAndRetry: 'ページを更新してもう一度お試しください。',
            tagDuplicate: 'タグを重複して追加することはできません',
            coauthorDuplicate: '共同作者を重複して追加することはできません',
            itemAlreadyAdded: 'アイテムはすでに追加されています',
            draftRestored: '編集途中の下書きが見つかったため復元されました',
        },
        viewer: {
            show: 'セットアップを表示',
            hide: 'セットアップを非表示',
